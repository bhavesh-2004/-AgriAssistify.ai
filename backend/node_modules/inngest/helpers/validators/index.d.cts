...
import { ValidZodValue, ZodInfer, ZodTypeAny } from "./zod.cjs";
 ...
 * @public
 */
type ResolveSchema<TInput, TFallback = TInput, TUnknownFallback = TFallback> = IsUnknown<TInput> extends true ? TUnknownFallback : TInput extends ZodTypeAny ? ZodInfer<TInput> : TFallback;
/**
 * A valid input schema for an event's `data`.
 *
 * @public
 */
type ValidSchemaInput = ValidZodValue;
/**
 * A valid output schema.
 *
 * @public
 */
type ValidSchemaOutput = ZodTypeAny;
//#endregion
